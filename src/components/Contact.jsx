    ...
    <div name='contact' className='w-full h-screen bg-[#1D1E1F] flex justify-center items-center p-4'>
        <form method="POST" action='https://getform.io/f/6edc435c-3bbd-45a0-8b12-dbb62e93bc6b' className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='py-4 text-gray-300 '>Thanks for stopping by! I built this site to to showcase my proficiency in leveraging the following technologies: HTML, CSS, JavaScript, React, TailwindCSS. This site is also mobile friendly!</p>
